...
const Tables_Site = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        ...
        setData(response.data.results.fields)
        console.log(data)
      })
      .catch((error) => {
  ...
  const DeleteFunc = (e) => {
    axios
      .delete(`https://oiwaejofenwiaovjsoifaoiwnfiofweafj.site:8080/site/${e}`, {
        headers: {
          'Access-Control-Allow-Origin': 'https://oiwaejofenwiaovjsoifaoiwnfiofweafj.site:8080',
        },
        ...
        <CCol xs={12}>
          <CCard className="mb-4">
            ...
            <CCardBody>
              <CTable>
                <CTableHead>
                  <CTableRow>
                    ...
                    <CTableHeaderCell scope="col">Number of Workers</CTableHeaderCell>
                    <CTableHeaderCell scope="col"></CTableHeaderCell>
                  </CTableRow>
                </CTableHead>
                <CTableBody>
                  {data.map((item, index) => (
                    ...
                    >
                      ...
                      <CTableDataCell>{item.numOfWorkers}</CTableDataCell>
                      <CTableDataCell
              ...
              <CButton href="#/register_site">new Site</CButton>
            </CCardBody>
          </CCard>
        </CCol>
      </CRow>
